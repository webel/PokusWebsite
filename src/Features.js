        ...
        <div style={styles.layout}>
          ...
          <div style={styles.content}>
            ...
            <h5>
              ...
              Your in a state of mind, you don't want to throw that out to
              gossip or to look at a cat gif!{" "}
            </h5>
          </div>
          ...
          <div style={styles.content}>
            ...
            <h5>
              ...
              beyond common. We <i> need </i> to rewire that habit, it is a
              habit after all.
            </h5>
          </div>
          ...
          <div style={styles.content}>
            ...
            <h5>
              ...
              Give it a go on our virtual Pokus to the right! It's nice, right?{" "}
            </h5>
            <h5>
              {" "}
              The more you press that button, and <i>actually</i> focus for the
              full round, the liklier you are to be focused. We're mapping a
              habit to an action, *click*... focus... Click.. Focus.. Click.
              Focus.{" "}
            </h5>
            <h5>
              {" "}
            ...
            <h5>
              ...
              focusing to date &#8212; The Pomodoro Timer. Sure, you could get
              it as an app on your phone, but we are certain that there are
              others out there like us...{" "}
              <i>
                {" "}
                I'll just check how long till the end of the pomodoro... oh
                look, a message!{" "}
              </i>{" "}
            </h5>
            <h5>
              {" "}
              Instead of hiding the time, it's just <i> there </i>, so you have
              a clear indication of how long you've been focusing at all time!{" "}
            </h5>
            ...
            <h5>
              ...
              your online addictions. Full withdrawl. Cold turkey. Well, just
              for 25 minutes (or number of minutes of your choosing). Upon
              button press, a blacklist of your choice is blocked. You simply
              will have nothing better to do than to <i> focus </i>{" "}
            </h5>
          </div>
          ...
          <div style={styles.content}>
            <h4 style={styles.nugget}>
              {" "}
              Not only do you know you are focusing, but so does your
              surroundings{" "}
            </h4>
            <h5>
              {" "}
              No need to politely nod at a chatty coworker while you're trying
              to work, because they'll now know when it's appropiate to approach
              you!{" "}
            </h5>
            <h5>
              {" "}
